...
- (void)presentPopupView:(UIView*)popupView animationType:(MJPopupViewAnimation)animationType dismissed:(void(^)(void))dismissed
{
    ...
    shareButton.backgroundColor = pizzaRedColor;
    [[shareButton layer] setMasksToBounds:YES];
    [[shareButton layer] setBorderWidth:0.0f];
...
-(IBAction)shareWithFriends:(id)sender{
    ...
    NSArray* dataToShare = @[@"I just bought a pizza at the tap of a button with Pizza the App! Go to www.pizzatheapp.com and get your delicious, local pizza pie."];
